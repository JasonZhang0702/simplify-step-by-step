...
if __name__ == '__main__':
    ...
    case_dict_expert = json.load(open(f"/root/codes/MultiRCTS/data/prompt_expert/en_expert_case_cefrsp.json"))
    case_dict_expert = padding_case(case_dict_expert)  # expert guided prompting

    casedf = pd.read_csv(f"/root/codes/MultiRCTS/data/en/CEFR-SP_train.csv")
